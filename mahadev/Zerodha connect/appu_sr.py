...
INPUT_SHEET = "appu_input" #---> Change to "input1" for trade-focused sheet or F&O
OUTPUT_SHEET = "sroutput_multitf" if MULTI_TF_MODE else f"appu_sroutput_{SELECTED_TF}"
JSON_FILE = f"appu_sup&res_{SELECTED_TF}.json"
