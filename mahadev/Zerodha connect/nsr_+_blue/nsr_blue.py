...
INPUT_SHEET = "input5"
OUTPUT_SHEET = f"Nsrblue_trade__{SELECTED_TF}"
JSON_FILE = f"Nsrblue_trade_{SELECTED_TF}.json"          # Stores full analysis results for history.
ORDER_FILE = f"Nsrblue_order_sent_{SELECTED_TF}.json"        # Stores (symbol, S/R value, direction) to prevent duplicate orders.
